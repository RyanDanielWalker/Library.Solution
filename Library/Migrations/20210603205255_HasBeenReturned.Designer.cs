...
namespace Library.Migrations
{
    ...
    [Migration("20210603205255_HasBeenReturned")]
    partial class HasBeenReturned
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.CopyPatron", b =>
                {
                    b.HasOne("Library.Models.Copy", "Copy")
                        .WithMany("CopyPatronJoinEntities")
                        .HasForeignKey("CopyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library.Models.ApplicationUser", "Patron")
                        .WithMany("CopyPatronJoinEntities")
            ...
            modelBuilder.Entity("Library.Models.ApplicationUser", b =>
                {
                    b.Navigation("CopyPatronJoinEntities");
                });
